...
| [target](#target)                                             | `object`   | **Required** | No       | Experiment (this schema)                   |
...
Summary of 'target', copied from 'sequence_feature', 'gene_id', 'gene_product', or 'macromolecular_structure' (and
adding 'target_detail'), according to 'technique'
